		...
		<div className="App">
			...
			<div className="home-page">
				<span>
					...
					<p>
						One of the key features of this app is its seamless integration with
						the Open Movie Database API, which provides access to a vast library
						of movie information.
						<br /> This means that you can be confident that you're getting the
						most accurate and up-to-date information on your favorite films.
					</p>
				</span>
			</div>
			<Slider />
