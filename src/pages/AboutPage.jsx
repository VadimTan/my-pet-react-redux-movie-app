			...
			<div className="about-me-info">
				<span>
					...
					<p className="text-about-me">
						Hi there, my name is Vadim and I am a Junior Front End Developer. I
						have always had a passion for creating things and as I began to
					...
					<p className="text-about-me">
						...
						Collaboration is an essential part of my work as a developer, and I
						pride myself on being a team player.
					...
					<p className="text-about-me">
						...
						eager to take on new challenges, I would love to hear from you.
